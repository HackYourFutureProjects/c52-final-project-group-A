...
export default function SearchBox({ onClose }) {
  ...
  // The performFetch function from this hook will be called without arguments
  const { isLoading, error, performFetch, cancelFetch } = useFetch(
    `/search?q=${encodeURIComponent(query)}&type=${type}`,
    onReceived,
  );

  // This effect triggers the search after a delay
  useEffect(() => {
  ...
  }, [query, type]); // Rerun only when query or type changes
